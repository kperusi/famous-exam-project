  ...
  return (
    <div className={styles.top}>
      ...
      <div className={styles.btnWrap}>
         <button className={styles.btn} onClick={()=>{setCurrentPage(currentPage-1)}}  disabled={currentPage<=1}>More-</button>
        <button className={styles.btn} onClick={()=>{setCurrentPage(currentPage+1)}} disabled= {currentPage>NumberOfPages-1}>More+</button>
